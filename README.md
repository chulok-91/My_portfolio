...
| Анализ данных рынка компьютерных игр | Анализ данных о продажах компьютерных игр. Выявление закономерностей, влияющих на успешность игры. | *pandas, matplotlib, seaborn, numpy, scipy* |
